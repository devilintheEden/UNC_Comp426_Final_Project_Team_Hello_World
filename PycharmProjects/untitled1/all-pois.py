def h_pos(Hospital_length_of_stay_mean, Hospital_length_of_stay_std, Hospital_initial_condition, rate,
    ...
    while t <= TotalTimeLength:
        ...
        while tempcdf <= 0.99:
            if t < 40:
                tempcdf = poisson.cdf(temptotal, mt_temp)
            else:
    ...
    data = {
        "Num Pts": ["25pts", "50pts", "75pts", "100pts", "125pts", "150pts", "175pts"],
...
def icu_pos(ICU_length_of_stay_mean, ICU_length_of_stay_std, ICU_initial_condition, rate, Percentage_icu):
    ...
    while t <= TotalTimeLength:
        ...
        while tempcdf <= 0.99:
            if t < 40:
                tempcdf = poisson.cdf(temptotal, mttemp)
            else:
                tempcdf = poisson.cdf(temptotal, ans)
            if tempcdf >= 0.05 and flag[0] == False:
                if temptotal - 1 > 0:
    ...
    data = {
        "Num Pts": ["15pts", "20pts", "25pts", "30pts", "35pts", "40pts", "45pts"],
...
def ed_pos(ED_length_of_stay_mean, ED_length_of_stay_std, ED_initial_condition, Daily_arrival_rate, Hourly_pattern):
    ...
    data = {
        "Num Pts": ["10pts", "15pts", "20pts", "25pts", "30pts", "35pts", "40pts"],
