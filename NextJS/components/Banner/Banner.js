import { ChevronRight, ChevronLeft, CircleFill, Circle } from 'react-bootstrap-icons';
...
function Banner() {
    ...
    return (
        <div className='bg-gray pt5 relative overflow-hidden'>
            ...
            <div className='absolute right-2 top-0 h-100 w3 pointer'
                id='right'
                onClick={onClick}>
                <ChevronRight size='48' className={styles.mid} />
            </div>

            <div className='absolute left-2 top-0 h-100 w3 pointer'
                id='left'
                onClick={onClick}>
