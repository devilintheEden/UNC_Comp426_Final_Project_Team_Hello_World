  ...
  render() {
    return (
      <div className="ba b--dashed ma1 pb3">
        <p className="ma2 pa1"> Enter the ratio of width and height for your grids and Download the pdf template. Input must be positive integers.</p>
      <form className="mh2 ph2" onSubmit={this.handleSubmit}>
        ...
        <input className="f6 ba mv2 pv1 dib black" type="submit" value="Download Template" />
      </form>
      </div>
    );
  }
